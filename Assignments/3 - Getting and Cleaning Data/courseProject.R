#This code was written as part of the course project for the Coursera Getting and Cleaning Data class. See the README 
#   and ProjectCodeBook for further details.

#Updated 06.15.15 by K. Divis

#Note: As per assignment directions, assumes this code assumes the HCI HAR dataset is the current working directory.
...
#########################################################################################################
# Step 5: Create a second data set with the average of each varaible for each activity and each subject #
#########################################################################################################
