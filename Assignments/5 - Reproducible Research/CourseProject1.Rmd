...
This was completed as part of the Reproducible Research class in the Johns Hopkins Data Science Specialization on Coursera. Instructions/requirements can be found in the accompanying **CourseProject1Instructions.pdf** file.
...
Devise a strategy for filling in all the missing values in the dataset. The strategy does not need to be sophisticated. For example, you could use the mean/median for that day, or the mean for that 5-minute interval, etc. *My strategy will be to replcae the NAs with the mean (across days) for that 5-minute interval.*   
