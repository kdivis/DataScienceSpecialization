---
title: "Course Project Instructions (Practical Machine Learning)"
output: pdf_document
---
...
here: http://groupware.les.inf.pucrio.br/har (see the section on the Weight
...
The data for this project come from this source: http://groupware.les.inf.pucrio.br/har     
...
will make it easier for the graders if you submit a repo with a ghpages
branch so the HTML page can be viewed
